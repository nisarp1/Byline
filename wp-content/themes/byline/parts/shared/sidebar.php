...
<?php if (!empty($trending_posts)) : ?>
    ...
    <div class="media post-block small-block">
        ...
        <div class="media-body">
            ...
            <div class="post-stats">
                <small class="text-muted">
                    <?php if ($using_simple_algorithm) : ?>
                        <i class="fas fa-chart-line text-warning"></i> Trending (Simple)
                    <?php else : ?>
                        <i class="fas fa-fire text-danger"></i> Trending
                    <?php endif; ?>
                    <i class="far fa-eye ml-2"></i> <?php echo number_format($post_data['view_count']); ?> views
                    <i class="far fa-comment ml-2"></i> <?php echo number_format($post_data['comment_count']); ?> comments
