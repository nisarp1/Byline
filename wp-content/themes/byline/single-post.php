    ...
    <div class="container">
        <div class="section-title m-b-xs-20">
            <a href="#" class="d-block">
                <h2 class="axil-title gallery-title">IMAGE GALLERY</h2>
            </a>
        </div>
        ...
        <div class="grid-wrapper">
            <div class="row">
                <div class="col-lg-4 col-md-4">
                    <div class="axil-img-container flex-height-container gallery-container__type-2 m-b-xs-30 post-image-wrapper" data-gallery="gallery1">
                        ...
                        <div class="post-image-wrapper gallery-overlay">
                            <div class="post-cat-group badge-on-image">
                                <a href="#" class="post-cat cat-btn btn-big bg-primary-color">GALLERY</a>
                            </div>
                        </div>
                        <a href="single-post.php" class="block-link">
                            <div class="media post-block grad-overlay__transparent position-absolute">
                                <div class="media-body media-body__big">
                                    <div class="axil-media-bottom mt-auto">
                                        <h3 class="axil-post-title hover-line">ജനനായകന്റെ അന്ത്യയാത്ര: വി.എസ്. അച്യുതാനന്ദന് വിട</h3>
                ...
                <div class="col-lg-4 col-md-4">
                    <div class="axil-img-container flex-height-container gallery-container__type-2 m-b-xs-30 post-image-wrapper" data-gallery="gallery2">
                        <div class="gallery-image-wrapper d-block h-100">
                        ...
                        <a href="single-post.php" class="block-link">
                            <div class="media post-block grad-overlay__transparent position-absolute">
                                <div class="media-body media-body__big">
                                    <div class="axil-media-bottom mt-auto">
                                        <h3 class="axil-post-title hover-line"><?php echo get_the_title(); ?></h3>
                ...
                <div class="col-lg-4 col-md-4">
                    <div class="axil-img-container flex-height-container gallery-container__type-2 m-b-xs-30 post-image-wrapper" data-gallery="gallery3">
                        <div class="gallery-image-wrapper d-block h-100">
